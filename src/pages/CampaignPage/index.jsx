...
const {closeDailog, openDialoge} = useContext(PopupContext)
  const listLinks = [{
    name: "עריכת רשימה", color: 'green', onClick:()=> openDialoge({comp:<Campaign_Form campaign={{title:campaign.title}}/>,title:"רשימה חדשה"}),icon: <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
