...
export default function MessagePage({ list }) {
    ...
    console.log('date', Msg.date.getDate());
    const dateTitleMsg = ` נוצר ב ${Msg.date.getDate()}/${Msg.date.getMonth() + 1}/${Msg.date.getFullYear()} ${Msg.date.getHours()}:${Msg.date.getMinutes() < 10 ? '0' + Msg.date.getMinutes() : Msg.date.getMinutes()}`
